...
class Task:
    ...
    def __init__(self, task_id: str, name: str, action: Callable, 
...
class WorkflowEngine:
    ...
    def add_task(self, task_id: str, name: str, action: Callable, 
                dependencies: Optional[List[str]] = None, priority: int = 0) -> Dict:
        """Görev ekle"""
    ...
    def add_tasks_to_workflow(self, workflow_id: str, 
    ...
    def execute_with_dependencies(self, workflow_id: str) -> Dict:
        ...
        for task_id in execution_order:
            ...
            if not self._check_dependencies_completed(task.dependencies, results):
                ...
                results["tasks"][task_id] = {"status": "skipped", 
    ...
    def _execute_sequential(self, task_ids: List[str], 
                          results: Dict) -> Dict:
        """Sırayla çalıştır"""
        context = {}
    ...
    def _execute_parallel(self, task_ids: List[str], 
                         results: Dict) -> Dict:
        """Paralel çalıştır"""
        threads = []
        context = {}
    ...
    def _check_dependencies_completed(self, dependencies: List[str],
                                     results: Dict) -> bool:
        """Bağımlılıklar tamamlandı mı"""
