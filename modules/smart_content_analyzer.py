...
class SmartContentAnalyzer:
    ...
    CONTENT_PATTERNS = {
        "code": {
            "patterns": ["def ", "class ", "function ", "import ", "require(", "return "],
    ...
    def categorize_content(self, content: str, file_type: str = "unknown") -> Dict:
        ...
        if categories:
            best_match = max(categories.items(), 
    ...
    def _detect_language(self, content: str) -> str:
        ...
        turkish_count = sum(1 for word in turkish_words 
                          if word in content.lower())
        english_count = sum(1 for word in english_words 
                          if word in content.lower())
