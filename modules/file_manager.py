...
class FileManager:
    ...
    def list_contents(self, path: str = ".", show_hidden: bool = False) -> Dict:
        ...
        try:
            ...
            for item in target_path.iterdir():
                ...
                try:
                    ...
                    info = {
                        ...
                        "size_human": self._format_size(stat.st_size) if item.is_file() else "DIR",
                        "created": datetime.fromtimestamp(stat.st_ctime).isoformat(),
                        "modified": datetime.fromtimestamp(stat.st_mtime).isoformat(),
            ...
            self.log_operation("list_contents", {"path": path, "items_found": result["items_found"]})
    ...
    def create_file(self, filename: str, content: str = "", overwrite: bool = False) -> Dict:
        """Dosya oluştur"""
        try:
...
"""
    ...
    def read_file(self, filepath: str, max_lines: int = 100) -> Dict:
        ...
        try:
            ...
            result = {
                ...
                "encoding": "utf-8",
                "content": content if len(lines) <= max_lines else ''.join(lines[:max_lines]) + "\n... [truncated]",
                "is_truncated": len(lines) > max_lines,
                "lines_shown": min(len(lines), max_lines)
            }
            
            self.log_operation("read_file", {"filename": filepath, "lines_read": result["lines_shown"]})
    ...
    def search_files(self, pattern: str, search_path: str = ".", 
                    search_content: bool = False, case_sensitive: bool = False) -> Dict:
    ...
    def get_file_stats(self, filepath: str) -> Dict:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Error getting file stats: {str(e)}"
            }
    ...
    def delete_directory(self, dirpath: str, recursive: bool = False) -> Dict:
        ...
        try:
            ...
            self.log_operation("delete_directory", {"path": dirpath, "recursive": recursive})
            
            return {
                "success": True,
                "message": f"Directory deleted: {dirpath}"
            }
