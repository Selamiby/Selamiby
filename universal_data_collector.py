...
class UniversalDataCollector:
    def __init__(self):
        ...
        self.programming_languages = [
            ...
            "TypeScript", "PHP", "Swift", "Kotlin", "Ruby", "Scala",
    ...
    async def collect_all_languages(self):
        ...
        summary["unique_programming_languages"] = list(summary["unique_programming_languages"])
        ...
        print(f"   • Bulunan programlama dilleri: {len(summary['unique_programming_languages'])}")
    ...
    def analyze_collected_data(self):
        ...
        data_files = [f for f in os.listdir("data") if f.endswith(".json") and f != "summary.json"]
                ...
                with open(f"data/{file}", "r", encoding="utf-8") as f:
                    ...
                    for block in data.get("code_blocks", []):
                        ...
                        analysis["programming_languages_distribution"][lang] = \
                            analysis["programming_languages_distribution"].get(lang, 0) + 1
        ...
        print(f"   • Kaplı diller: {', '.join(sorted(set(analysis['languages_covered'])))}")
        
        print("\n💻 PROGRAMLAMA DİLİ DAĞILIMI:")
        sorted_langs = sorted(analysis["programming_languages_distribution"].items(), 
