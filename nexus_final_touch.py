...
╚══════════════════════════════════════════════════════╝
        ...
        self.executor = RealtimeExecutor() if EXECUTOR_AVAILABLE else SimpleRealtimeExecutor()
        self.future = FuturePredictor() if FUTURE_AVAILABLE else SimpleFuturePredictor()
        self.robotics = RoboticsController() if ROBOTICS_AVAILABLE else SimpleRoboticsController()
...
'''
    ...
    def test_executor(self):
        ...
        return f"Kod çalıştı: {result['output'].strip() if 'output' in result else 'OK'}"
