...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "nexus_copilot_collaboration.log", encoding='utf-8'),
...
class NEXUSDecisionMaker:
    ...
    def should_approve(self, request_type: str, details: Dict) -> bool:
        ...
        if request_type in request_types_auto_approve:
            ...
            logger.info(f"✅ NEXUS KARAR: {request_type} → ONAYLANDI (Otomatik #{self.approved_count})")
            return True
