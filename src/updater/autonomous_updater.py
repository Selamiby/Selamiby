...
class SelfUpdater:
    ...
    def check_for_updates(self):
        ...
        try:
            ...
            remote_hash = repo.remotes.origin.refs.main.commit.hexsha # 'main' branch'i varsayılan
    ...
    def update_self(self):
        ...
        try:
            ...
            subprocess.run([sys.executable, "-m", "pip", "install", "--upgrade", "-r", str(requirements_path)], check=True)
